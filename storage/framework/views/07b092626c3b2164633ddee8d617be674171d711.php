            ...
            <div class="col-md-3">
                <div class="card" style="background-color:#E0E0E0; color:#424242;">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('login', ['rol' => 'admin'])); ?>" class="btn btn-dark fw-bold">Ingresar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color:#FF9800; color:#424242;">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('login', ['rol' => 'tecnico'])); ?>" class="btn btn-dark fw-bold">Ingresar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card" style="background-color:#FFC107; color:#424242;">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('login', ['rol' => 'cliente'])); ?>" class="btn btn-dark fw-bold">Ingresar</a>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\soporte_proyecto\resources\views/welcome.blade.php ENDPATH**/ ?>